        	...
        	<div id="root_site_container">
                ...
                <div id="content_main_container">
					<table id="index_main_table">
                    	<tr>
                    		<td>
                            	<p>This page belongs to Kingdom of Valour, a guild in the MMORPG Planeshift.<br>
                                If you are part of the guild, please register or log in to have internal access.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>   
                        ...
                        <tr>
                            <td>
                                ...
                                <p>Only guild intern sections are limited.<br>
