			...
			<div id="root_site_container">
				...
				<div id="content_main_container">
					...
					<tr class="quest_requirement">
						<td>Required: Rank 90 Dark Way, 1 Adept's Dark Way Wand, 1 Apprentice's Dark Way Robe.</td>
					</tr>
					...
					<tr class="quest_reward">
						<td>Rewards: 1 Daemon glyph, 1 Adept's Dark Way Robe, 1 Faction with Dark Order, 16400 XP.</td>
					</tr>
