 ...
 */
define("HOST", "wp067.webpack.hosteurope.de"); 			// The host you want to connect to. 
define("USER", "db11265213-kov"); 			// The database username. 
define("PASSWORD", "valourofkingdom"); 	// The database password. 
define("DATABASE", "db11265213-kov");             // The database name.
