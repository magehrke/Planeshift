...
<?php
    ...
    # This counter counts the different ip addresses who visit kingdomofvalour.de
...
<div id="head_main_container">
    <div class="header_container">
        ...
        <h1><a href="/">Kingdom of Valour</a></h1>
    </div>
</div>
...
<div id="navi_main_container">
    <div class="navi_container">
        <ul id="navigation_main">
            ...
            <!-- Navigation: Guild Button -->
            <li class="navigation_button_guild">
                Guild
                <ul class="navigation_dropdown_menu">
                   <li><a href="/guild/guildranks.php">Guildranks</a></li>
                   <li><a href="/guild/pictures.php">Pictures</a></li>
                </ul>
            </li>
            ...
            <li class="navigation_button_more">
            	More
                <ul class="navigation_dropdown_menu">
                    <li><a href="/more/lavacaveexit.php">Lava Cave Exit</a></li>
                    <li><a href="/more/nefasentrance.php">Nefas Entrance</a></li>
                    <li><a href="/more/grendolcave.php">Grendol Cave</a></li> 
               </ul>
            </li>
