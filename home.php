                                ...
                                <td>
                                    <table class="news_box">
                                        ...
                                        <tr>
                                            <td>
                                                <p>
                                                    Hello everyone. Today I added a page counter. Ok, i even added two. So the first one counts the total visits of the kingdomofvalour.de page and the second one counts the visit of different ip-addresses (closest thing to people). At the moment the counters are under the <a href="/" target="_blank">Home Section</a> and not as beautiful as I would like it to be. If you have an idea where to place it and how to change the style, please tell me. Fine. Let's see how much our site is in use. Take care and see you in game, Huarwar.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
